...
export const addblog =
  (user_id, username, title, category, content, imageUrlFirebase, contentMarkdown, contentHTML) => (dispatch) => {
    ...
    axios({
      ...
      data: {
        ...
        category: category,
        content: content,
        imageUrl: imageUrlFirebase ? imageUrlFirebase : "",
...
export const editblog = (id, title, category, content, imageUrlFirebase, contentMarkdown, contentHTML) => (dispatch) => {
