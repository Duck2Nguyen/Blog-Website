...
const Myblog = () => {
  ...
  const handleSearchValue = (type, value) => {
    ...
    if (type === "title") {
      blog.forEach((b) => {
        if (b.title.includes(value) && b.user_id === sessionStorage.getItem("id")) {
          arrayBlogs.push(b)
        }
      })
    }
      ...
      blog.forEach((b) => {
        if (b.category.includes(value) && b.user_id === sessionStorage.getItem("id")) {
          arrayBlogs.push(b)
        }
      })
    }
      ...
      blog.forEach((b) => {
        if (b.content.includes(value) && b.user_id === sessionStorage.getItem("id")) {
          arrayBlogs.push(b)
        }
      })
    }
